...
export default function MovementHistoryPage() {
  ...
  const [filterShift, setFilterShift] = useState<"" | "morning" | "evening">(
    "",
  );
    ...
    <div className="animate-fade-in">
      <div className="text-right mb-6">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">
          جميع عمليات الوارد والصادر والتعديلات
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-4 mb-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-2">
          ...
          <div>
            ...
            <select
              value={filterShift}
              onChange={(e) =>
                setFilterShift(e.target.value as "" | "morning" | "evening")
              }
              dir="rtl"
        ...
        <p className="text-xs text-gray-400 mt-2 text-right">
          إجمالي النتائج: {filtered.length} حركة
        </p>
      </div>
                ...
                filtered.map((m, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 font-medium text-[#2d5a8e]">
                        {m.newQuantity}
                      </td>
